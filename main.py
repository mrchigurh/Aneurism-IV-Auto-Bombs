...
# CONFIG5 #Amount of seconds of no bombs popping up to try to pull lever.

USE_INSPECT_IDENTIFIER = False # Will wait for inspect identifier before clicking E (slower)
TOGGLE_KEY = 'x'
END_SCRIPT_KEY = 'z'
